...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المصروفات و الإيرادات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ اضافة
                معاملة</span>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    {{ Form::open(['route' => 'accounts.create', 'class' => 'parsley-style-1']) }}
                    <div class="row mg-b-20">
                        <div class="parsley-input col-md-6" id="fnWrapper">
                            {!! Html::decode(Form::label('username', 'اسم المستخدم : '))!!}
                            {!! Form::text('username', auth()->user()->name,['class'=>'form-control form-control-sm mg-b-20"
                                               data-parsley-class-handler="#lnWrapper', 'readonly' ]) !!}
                        </div>
                        <div class="col-md-6">
                            {!! Html::decode(Form::label('type', 'نوع المعاملة : <span class="tx-danger">*</span>'))!!}
                            {!! Form::select('type',  ['ايرادات','مصروفات'],old('type'), array('placeholder' => 'من فضلك اختر نوع المعاملة',  'class' => 'form-control  nice-select  custom-select' )) !!}
                        </div>
                    </div>
                    <div class="row mg-b-20">
                        <div class="parsley-input col-md-6" id="fnWrapper">
                        ...
                        <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                            ...
                            {!! Form::text('money_amount', old('money_amount'),['class'=>'form-control form-control-sm mg-b-20"
                                               data-parsley-class-handler="#lnWrapper' ]) !!}
                        </div>
                    </div>
                    <div class="row mg-b-20">
